...
test('Renders a birthday header with 2 people under thate date', () => {
  ...
  const personOne = screen.getByText(/Rocky, South Korean singer, dancer and songwriter 1/i);
  const personTwo = screen.getByText(/Rocky, South Korean singer, dancer and songwriter 2/i);
